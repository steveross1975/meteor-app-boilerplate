...
import { yourServerApi } from './yourServerApi';
...
if (Meteor.isServer) {
  describe  ('notes', function () {
    ...
    beforeEach(function () {
      yourServerApi.remove({});
      yourServerApi.insert(noteOne);
      yourServerApi.insert(noteTwo);
    });
    //methods test
    it('should insert new note', function () {
      const userId = 'testId';
      const _id = Meteor.server.method_handlers['notes.insert'].apply({userId});
      expect(yourServerApi.findOne({ _id, userId })).toBeTruthy();
    });
    ...
    it('should remove note', function() {
      ...
      expect(yourServerApi.findOne({_id: noteOne._id})).toBeFalsy();
    });
    ...
    it('should update note', function () {
      ...
      const note = yourServerApi.findOne(noteOne._id);
